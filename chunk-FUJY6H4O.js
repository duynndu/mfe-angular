import{a as l,b as s}from"./chunk-DRMXH472.js";import{bootstrapApplication as z}from"@angular/platform-browser";import{provideBrowserGlobalErrorListeners as E,provideZoneChangeDetection as D}from"@angular/core";import{provideRouter as T}from"@angular/router";import{EventEmitter as f}from"@angular/core";import{FormsModule as P}from"@angular/forms";import*as d from"@angular/core";var g="./template-editor/assets/remoteEntry.js";import*as C from"@angular/core";var h=class r{module=null;_initVueModule(){return l(this,null,function*(){if(!this.module)try{this.module=yield s({remoteEntry:g,exposedModule:"./component-factory"})}catch(a){console.error("[VueLoader] Failed to load Vue remote module:",a),this.module=null}})}createPreview(){return l(this,null,function*(){yield this._initVueModule();try{if(!this.module?.createPreview)throw new Error("Vue module does not export createPreview.");return this.module.createPreview()}catch(a){return console.log(a),null}})}static \u0275fac=function(n){return new(n||r)};static \u0275prov=C.\u0275\u0275defineInjectable({token:r,factory:r.\u0275fac,providedIn:"root"})};var b=class r{constructor(a){this.vueLoader=a}app=null;vm=null;template="";templateChange=new f;script="";scriptChange=new f;context={};contextChange=new f;editMode=!0;editModeChange=new f;ngOnInit(){return l(this,null,function*(){if(this.app=yield this.vueLoader.createPreview(),!this.app)return console.error("Failed to load Vue preview component.");this.vm=this.app.mount("#template-editor");let a=this.vm.$data;a&&(this.template&&(a.template=this.template),this.script&&(a.script=this.script),this.context&&Object.keys(this.context).length>0&&(a.context||(a.context={}),Object.assign(a.context,this.context)),a.editMode=this.editMode),this.contextChange.emit(a?.context??this.context),this.vm.$watch("context",n=>{this.contextChange.emit(n)},{deep:!0}),this.vm.$watch("template",n=>{this.templateChange.emit(n)}),this.vm.$watch("script",n=>{this.scriptChange.emit(n)}),this.vm.$watch("editMode",n=>{this.editModeChange.emit(n)})})}ngOnChanges(a){if(!this.vm)return;let n=this.vm.$data;n&&(a.context&&this.context&&(n.context||(n.context={}),Object.assign(n.context,this.context)),a.script&&(n.script=this.script),a.template&&(n.template=this.template),a.editMode&&(n.editMode=this.editMode))}ngOnDestroy(){this.app?.unmount()}static \u0275fac=function(n){return new(n||r)(d.\u0275\u0275directiveInject(h))};static \u0275cmp=d.\u0275\u0275defineComponent({type:r,selectors:[["template-editor"]],inputs:{template:"template",script:"script",context:"context",editMode:"editMode"},outputs:{templateChange:"templateChange",scriptChange:"scriptChange",contextChange:"contextChange",editModeChange:"editModeChange"},features:[d.\u0275\u0275NgOnChangesFeature],decls:1,vars:0,consts:[["id","template-editor"]],template:function(n,i){n&1&&d.\u0275\u0275element(0,"div",0)},dependencies:[P],encapsulation:2})};import{FormsModule as O}from"@angular/forms";import*as e from"@angular/core";import*as p from"@angular/forms";var m=class r{template=`<PageA4 style="padding:3mm 15mm" c-name="PageA4" c-id="u30lyv7">
