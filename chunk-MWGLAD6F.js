import{a as m,b as l}from"./chunk-DRMXH472.js";import{bootstrapApplication as E}from"@angular/platform-browser";import{provideBrowserGlobalErrorListeners as O,provideZoneChangeDetection as P}from"@angular/core";import{provideRouter as _}from"@angular/router";import{EventEmitter as f}from"@angular/core";import{FormsModule as w}from"@angular/forms";import*as d from"@angular/core";import*as b from"@angular/core";var u=class n{module=null;_initVueModule(){return m(this,null,function*(){if(!this.module)try{this.module=yield l({remoteName:"templateEditor",exposedModule:"./component-factory"})}catch(a){console.error("[VueLoader] Failed to load Vue remote module:",a),this.module=null}})}createPreview(){return m(this,null,function*(){yield this._initVueModule();try{if(!this.module?.createPreview)throw new Error("Vue module does not export createPreview.");return this.module.createPreview()}catch(a){return console.log(a),null}})}static \u0275fac=function(i){return new(i||n)};static \u0275prov=b.\u0275\u0275defineInjectable({token:n,factory:n.\u0275fac,providedIn:"root"})};var h=class n{constructor(a){this.vueLoader=a}app=null;vm=null;template="";templateChange=new f;data={};dataChange=new f;editMode=!0;editModeChange=new f;ngOnInit(){return m(this,null,function*(){if(this.app=yield this.vueLoader.createPreview(),!this.app)return console.error("Failed to load Vue preview component.");this.vm=this.app.mount("#template-editor");let a=this.vm.$data;a&&(a.data=this.data,a.template=this.template,a.editMode=this.editMode),this.dataChange.emit(a?.data??this.data),this.vm.$watch("template",i=>{this.templateChange.emit(i)}),this.vm.$watch("editMode",i=>{this.editModeChange.emit(i)})})}ngOnChanges(a){if(!this.vm)return;let i=this.vm.$data;i&&(a.template&&(i.template=this.template),a.editMode&&(i.editMode=this.editMode))}ngOnDestroy(){this.app?.unmount()}static \u0275fac=function(i){return new(i||n)(d.\u0275\u0275directiveInject(u))};static \u0275cmp=d.\u0275\u0275defineComponent({type:n,selectors:[["template-editor"]],inputs:{template:"template",data:"data",editMode:"editMode"},outputs:{templateChange:"templateChange",dataChange:"dataChange",editModeChange:"editModeChange"},features:[d.\u0275\u0275NgOnChangesFeature],decls:1,vars:0,consts:[["id","template-editor"]],template:function(i,o){i&1&&d.\u0275\u0275element(0,"div",0)},dependencies:[w],encapsulation:2})};import{FormsModule as D}from"@angular/forms";import*as t from"@angular/core";var p=class n{template=`<PageA4 style="padding:3mm 15mm" c-name="PageA4" c-id="u30lyv7">
