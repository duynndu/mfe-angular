import{P as s,_ as l,r as d,c as h,o as g,a as m,W as p,Q as u}from"./vue3-context-menu-YN1fCJ0q.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const v=`<PageA4 style="padding:3mm 15mm">
  <div
...
</PageA4>`,b={name:"PreviewWrapper",components:{Preview:s},data(){return{editMode:!0,template:v,script:`// 📜 Khởi tạo state từ $context truyền từ Angular Host
...
Atorvastatin 20mg x 1 viên/ngày (uống tối)`,doctorAdvice:"Nghỉ ngơi hợp lý, tránh lao động nặng và căng thẳng. Ăn giảm muối, hạn chế dầu mỡ. Tái khám sau 2 tuần hoặc ngay khi cơn đau ngực tăng nặng.",tags:["vue","typescript"],category:"tech",gender:"male",sizeTest:"large",birthdayText:"",appointment:"",signature:"",doctorSignature:""},medicalRecord:{code:"BA-2026/TM-0889",patientId:"BN-98234",department:"Khoa Tim Mạch - Can Thiệp",room:"P.402",bed:"G-12",admissionDate:"28/08/2026 08:30",dischargeDate:"30/08/2026 16:00",insuranceCode:"DN-4-01-01-2093849",bloodType:"O+",vitals:{pulse:78,bloodPressure:"135/85",temperature:36.8,weight:68,height:172,spO2:98},attendingDoctor:"BS. CKI Nguyễn Hải Đăng",icd10:"I20.8 - Cơn đau thắt ngực khác",isEmergency:!1}}}}};function y(c,n,o,r,e,t){const i=d("Preview");return g(),h(i,{template:e.template,"onUpdate:template":n[0]||(n[0]=a=>e.template=a),script:e.script,"onUpdate:script":n[1]||(n[1]=a=>e.script=a),context:e.context,editMode:e.editMode,"onUpdate:editMode":n[2]||(n[2]=a=>e.editMode=a)},null,8,["template","script","context","editMode"])}const x=l(b,[["render",y]]);m(x).use(p).use(u).mount("#app");
