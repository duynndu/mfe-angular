import{a as s,b as p}from"./chunk-DRMXH472.js";import{bootstrapApplication as Y}from"@angular/platform-browser";import{provideBrowserGlobalErrorListeners as z,provideZoneChangeDetection as S}from"@angular/core";import{provideRouter as A}from"@angular/router";import{EventEmitter as m}from"@angular/core";import*as c from"@angular/core";var x="./template-editor/assets/remoteEntry.js";import*as y from"@angular/core";var u=class o{module=null;_initVueModule(){return s(this,null,function*(){if(!this.module)try{this.module=yield p({remoteEntry:x,exposedModule:"./component-factory"})}catch(i){console.error("[VueLoader] Failed to load Vue remote module:",i),this.module=null}})}mountPreview(i,t){return s(this,null,function*(){yield this._initVueModule();try{if(!this.module?.mountPreview)throw new Error("Vue module does not export mountPreview.");return this.module.mountPreview(i,t)}catch(n){return console.error("[VueLoader] Failed to mount preview:",n),null}})}static \u0275fac=function(t){return new(t||o)};static \u0275prov=y.\u0275\u0275defineInjectable({token:o,factory:o.\u0275fac,providedIn:"root"})};var P=["container"],b=class o{constructor(i){this.vueLoader=i}containerRef;previewInstance=null;template="";templateChange=new m;script="";scriptChange=new m;context={};contextChange=new m;editMode=!0;editModeChange=new m;scriptError=new m;ngOnInit(){return s(this,null,function*(){let i=this.containerRef?.nativeElement||"#template-editor";this.previewInstance=yield this.vueLoader.mountPreview(i,{template:this.template,script:this.script,context:this.context,editMode:this.editMode,onTemplateChange:t=>{this.template=t,this.templateChange.emit(t)},onScriptChange:t=>{this.script=t,this.scriptChange.emit(t)},onContextChange:t=>{this.context=t,this.contextChange.emit(t)},onEditModeChange:t=>{this.editMode=t,this.editModeChange.emit(t)},onScriptError:t=>{this.scriptError.emit(t)}}),this.previewInstance||console.error("[TemplateEditor] Failed to load & mount Vue Preview component.")})}ngOnChanges(i){if(!this.previewInstance)return;let t={};i.template&&(t.template=this.template),i.script&&(t.script=this.script),i.context&&(t.context=this.context),i.editMode&&(t.editMode=this.editMode),Object.keys(t).length>0&&this.previewInstance.updateProps(t)}ngOnDestroy(){this.previewInstance?.unmount(),this.previewInstance=null}static \u0275fac=function(t){return new(t||o)(c.\u0275\u0275directiveInject(u))};static \u0275cmp=c.\u0275\u0275defineComponent({type:o,selectors:[["template-editor"]],viewQuery:function(t,n){if(t&1&&c.\u0275\u0275viewQuery(P,7),t&2){let r;c.\u0275\u0275queryRefresh(r=c.\u0275\u0275loadQuery())&&(n.containerRef=r.first)}},inputs:{template:"template",script:"script",context:"context",editMode:"editMode"},outputs:{templateChange:"templateChange",scriptChange:"scriptChange",contextChange:"contextChange",editModeChange:"editModeChange",scriptError:"scriptError"},features:[c.\u0275\u0275NgOnChangesFeature],decls:2,vars:0,consts:[["container",""],["id","template-editor"]],template:function(t,n){t&1&&c.\u0275\u0275element(0,"div",1,0)},encapsulation:2})};import{FormsModule as w}from"@angular/forms";import{CommonModule as N}from"@angular/common";import*as e from"@angular/core";import*as l from"@angular/forms";var H=(o,i)=>i.id;function I(o,i){if(o&1){let t=e.\u0275\u0275getCurrentView();e.\u0275\u0275elementStart(0,"button",16),e.\u0275\u0275listener("click",function(){let r=e.\u0275\u0275restoreView(t).$index,d=e.\u0275\u0275nextContext();return e.\u0275\u0275resetView(d.selectTemplate(r))}),e.\u0275\u0275elementStart(1,"span",17),e.\u0275\u0275text(2),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(3,"span",18),e.\u0275\u0275text(4),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(5,"span",19),e.\u0275\u0275text(6),e.\u0275\u0275elementEnd()()}if(o&2){let t=i.$implicit,n=i.$index,r=e.\u0275\u0275nextContext();e.\u0275\u0275classProp("active",r.selectedTemplateIndex===n),e.\u0275\u0275property("title",t.name+" ("+t.badge+"): "+t.description),e.\u0275\u0275advance(2),e.\u0275\u0275textInterpolate(t.icon),e.\u0275\u0275advance(2),e.\u0275\u0275textInterpolate(t.name),e.\u0275\u0275advance(),e.\u0275\u0275classProp("badge-a5",t.badge.includes("A5"))("badge-landscape",t.badge.includes("Ngang")),e.\u0275\u0275advance(),e.\u0275\u0275textInterpolate(t.badge)}}function D(o,i){if(o&1){let t=e.\u0275\u0275getCurrentView();e.\u0275\u0275elementStart(0,"div",12)(1,"span",20),e.\u0275\u0275text(2,"\u{1F170}\uFE0F Cha"),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(3,"div",21)(4,"label",22),e.\u0275\u0275text(5,"T\xEAn:"),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(6,"input",23),e.\u0275\u0275twoWayListener("ngModelChange",function(r){e.\u0275\u0275restoreView(t);let d=e.\u0275\u0275nextContext();return e.\u0275\u0275twoWayBindingSet(d.context.data.name,r)||(d.context.data.name=r),e.\u0275\u0275resetView(r)}),e.\u0275\u0275elementEnd()()()}if(o&2){let t=e.\u0275\u0275nextContext();e.\u0275\u0275advance(6),e.\u0275\u0275twoWayProperty("ngModel",t.context.data.name)}}function O(o,i){if(o&1&&(e.\u0275\u0275elementStart(0,"div",13),e.\u0275\u0275element(1,"span",24),e.\u0275\u0275elementStart(2,"span",25),e.\u0275\u0275text(3,"IP:"),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(4,"span",26),e.\u0275\u0275text(5),e.\u0275\u0275elementEnd()()),o&2){let t=e.\u0275\u0275nextContext();e.\u0275\u0275advance(5),e.\u0275\u0275textInterpolate(t.context.data.ip)}}var g=class o{templates=[{id:"demo-components",name:"Demo T\u1ED5ng h\u1EE3p",badge:"A4",icon:"\u{1F4CB}",description:"Tr\xECnh di\u1EC5n \u0111\u1EA7y \u0111\u1EE7 c\xE1c component: PageA4, Textarea, OTP, Select, DatePicker, Checkbox, Paint, ContextMenu v\xE0 Async Top-level Await",template:`<PageA4 style="padding:3mm 15mm" c-name="PageA4" c-id="u30lyv7">
