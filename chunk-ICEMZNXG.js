import{a as p,b as s}from"./chunk-DRMXH472.js";import{bootstrapApplication as V}from"@angular/platform-browser";import{provideBrowserGlobalErrorListeners as H,provideZoneChangeDetection as z}from"@angular/core";import{provideRouter as E}from"@angular/router";import{EventEmitter as x}from"@angular/core";import{FormsModule as w}from"@angular/forms";import*as l from"@angular/core";var h="./template-editor/assets/remoteEntry.js";import*as y from"@angular/core";var u=class r{module=null;_initVueModule(){return p(this,null,function*(){if(!this.module)try{this.module=yield s({remoteEntry:h,exposedModule:"./component-factory"})}catch(n){console.error("[VueLoader] Failed to load Vue remote module:",n),this.module=null}})}createPreview(){return p(this,null,function*(){yield this._initVueModule();try{if(!this.module?.createPreview)throw new Error("Vue module does not export createPreview.");return this.module.createPreview()}catch(n){return console.log(n),null}})}static \u0275fac=function(t){return new(t||r)};static \u0275prov=y.\u0275\u0275defineInjectable({token:r,factory:r.\u0275fac,providedIn:"root"})};var f=class r{constructor(n){this.vueLoader=n}app=null;vm=null;template="";templateChange=new x;script="";scriptChange=new x;context={};contextChange=new x;editMode=!0;editModeChange=new x;ngOnInit(){return p(this,null,function*(){if(this.app=yield this.vueLoader.createPreview(),!this.app)return console.error("Failed to load Vue preview component.");this.vm=this.app.mount("#template-editor");let n=this.vm.$data;n&&(this.template&&(n.template=this.template),this.script&&(n.script=this.script),n.context=this.context,n.editMode=this.editMode),this.contextChange.emit(n?.context??this.context),this.vm.$watch("context",t=>{this.contextChange.emit(t)},{deep:!0}),this.vm.$watch("template",t=>{this.templateChange.emit(t)}),this.vm.$watch("script",t=>{this.scriptChange.emit(t)}),this.vm.$watch("editMode",t=>{this.editModeChange.emit(t)})})}ngOnChanges(n){if(!this.vm)return;let t=this.vm.$data;t&&(n.context&&this.context&&(t.context=this.context),n.script&&(t.script=this.script),n.template&&(t.template=this.template),n.editMode&&(t.editMode=this.editMode))}ngOnDestroy(){this.app?.unmount()}static \u0275fac=function(t){return new(t||r)(l.\u0275\u0275directiveInject(u))};static \u0275cmp=l.\u0275\u0275defineComponent({type:r,selectors:[["template-editor"]],inputs:{template:"template",script:"script",context:"context",editMode:"editMode"},outputs:{templateChange:"templateChange",scriptChange:"scriptChange",contextChange:"contextChange",editModeChange:"editModeChange"},features:[l.\u0275\u0275NgOnChangesFeature],decls:1,vars:0,consts:[["id","template-editor"]],template:function(t,i){t&1&&l.\u0275\u0275element(0,"div",0)},dependencies:[w],encapsulation:2})};import{FormsModule as P}from"@angular/forms";import{CommonModule as O}from"@angular/common";import*as e from"@angular/core";import*as c from"@angular/forms";var D=(r,n)=>n.id;function I(r,n){if(r&1){let t=e.\u0275\u0275getCurrentView();e.\u0275\u0275elementStart(0,"button",16),e.\u0275\u0275listener("click",function(){let d=e.\u0275\u0275restoreView(t).$index,o=e.\u0275\u0275nextContext();return e.\u0275\u0275resetView(o.selectTemplate(d))}),e.\u0275\u0275elementStart(1,"span",17),e.\u0275\u0275text(2),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(3,"span",18),e.\u0275\u0275text(4),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(5,"span",19),e.\u0275\u0275text(6),e.\u0275\u0275elementEnd()()}if(r&2){let t=n.$implicit,i=n.$index,d=e.\u0275\u0275nextContext();e.\u0275\u0275classProp("active",d.selectedTemplateIndex===i),e.\u0275\u0275property("title",t.name+" ("+t.badge+"): "+t.description),e.\u0275\u0275advance(2),e.\u0275\u0275textInterpolate(t.icon),e.\u0275\u0275advance(2),e.\u0275\u0275textInterpolate(t.name),e.\u0275\u0275advance(),e.\u0275\u0275classProp("badge-a5",t.badge==="A5"),e.\u0275\u0275advance(),e.\u0275\u0275textInterpolate(t.badge)}}function N(r,n){if(r&1){let t=e.\u0275\u0275getCurrentView();e.\u0275\u0275elementStart(0,"div",12)(1,"span",20),e.\u0275\u0275text(2,"\u{1F170}\uFE0F Cha"),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(3,"div",21)(4,"label",22),e.\u0275\u0275text(5,"T\xEAn:"),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(6,"input",23),e.\u0275\u0275twoWayListener("ngModelChange",function(d){e.\u0275\u0275restoreView(t);let o=e.\u0275\u0275nextContext();return e.\u0275\u0275twoWayBindingSet(o.context.data.name,d)||(o.context.data.name=d),e.\u0275\u0275resetView(d)}),e.\u0275\u0275elementEnd()()()}if(r&2){let t=e.\u0275\u0275nextContext();e.\u0275\u0275advance(6),e.\u0275\u0275twoWayProperty("ngModel",t.context.data.name)}}function S(r,n){if(r&1&&(e.\u0275\u0275elementStart(0,"div",13),e.\u0275\u0275element(1,"span",24),e.\u0275\u0275elementStart(2,"span",25),e.\u0275\u0275text(3,"IP:"),e.\u0275\u0275elementEnd(),e.\u0275\u0275elementStart(4,"span",26),e.\u0275\u0275text(5),e.\u0275\u0275elementEnd()()),r&2){let t=e.\u0275\u0275nextContext();e.\u0275\u0275advance(5),e.\u0275\u0275textInterpolate(t.context.data.ip)}}var m=class r{templates=[{id:"demo-components",name:"Demo T\u1ED5ng h\u1EE3p",badge:"A4",icon:"\u{1F4CB}",description:"Tr\xECnh di\u1EC5n \u0111\u1EA7y \u0111\u1EE7 c\xE1c component: PageA4, Textarea, OTP, Select, DatePicker, Checkbox, Paint, ContextMenu v\xE0 Async Top-level Await",template:`<PageA4 style="padding:3mm 15mm" c-name="PageA4" c-id="u30lyv7">
